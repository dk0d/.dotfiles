...
return {
		...
		n = {
				...
				-- Telescope
				["<leader>ff"] = { function() require("telescope.builtin").git_files() end, desc = "Search git tracked files" },
				["<leader>fa"] = { function() require("telescope.builtin").find_files() end, desc = "Search all files" },
